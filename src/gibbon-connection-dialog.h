...
#define GIBBON_CONNECTION_DIALOG(obj) \
        (G_TYPE_CHECK_INSTANCE_CAST ((obj), GIBBON_TYPE_CONNECTION_DIALOG, \
                GibbonConnectionDialog))
#define GIBBON_CONNECTION_DIALOG_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST ((klass), \
        GIBBON_TYPE_CONNECTION_DIALOG, GibbonConnectionDialogClass))
#define GIBBON_IS_CONNECTION_DIALOG(obj) \
        (G_TYPE_CHECK_INSTANCE_TYPE ((obj), \
                GIBBON_TYPE_CONNECTION_DIALOG))
#define GIBBON_IS_CONNECTION_DIALOG_CLASS(klass) \
        (G_TYPE_CHECK_CLASS_TYPE ((klass), \
                GIBBON_TYPE_CONNECTION_DIALOG))
#define GIBBON_CONNECTION_DIALOG_GET_CLASS(obj) \
 ...
 * GibbonConnectionDialog:
 *
 * One instance of a #GibbonConnectionDialog.  All properties are private.
 **/
...
/**
 * GibbonConnectionDialogClass:
 *
 * Class representing the connection dialog for Gibbon.
 **/
typedef struct _GibbonConnectionDialogClass GibbonConnectionDialogClass;
