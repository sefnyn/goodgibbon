...
extern GType gsgf_collection_get_type (void);
extern GType gsgf_color_get_type (void);
extern GType gsgf_component_get_type (void);
extern GType gsgf_compose_get_type (void);
extern GType gsgf_cooked_value_get_type (void);
extern GType gsgf_date_get_type (void);
extern GType gsgf_double_get_type (void);
extern GType gsgf_empty_get_type (void);
extern GType gsgf_flavor_backgammon_get_type (void);
extern GType gsgf_flavor_get_type (void);
extern GType gsgf_game_tree_get_type (void);
extern GType gsgf_list_of_get_type (void);
extern GType gsgf_move_backgammon_get_type (void);
extern GType gsgf_move_get_type (void);
extern GType gsgf_node_get_type (void);
extern GType gsgf_number_get_type (void);
extern GType gsgf_point_backgammon_get_type (void);
extern GType gsgf_point_get_type (void);
extern GType gsgf_property_get_type (void);
extern GType gsgf_raw_get_type (void);
extern GType gsgf_real_get_type (void);
extern GType gsgf_result_get_type (void);
extern GType gsgf_simple_text_get_type (void);
extern GType gsgf_stone_backgammon_get_type (void);
extern GType gsgf_stone_get_type (void);
extern GType gsgf_text_get_type (void);
extern GType gsgf_value_get_type (void);

#ifdef GTK_IS_WIDGET_CLASS
#include <gtk/gtk.h>
#endif
static GType object_types[28];
...
get_object_types (void)
{
  ...
  object_types[i++] = gsgf_collection_get_type ();
  object_types[i++] = gsgf_color_get_type ();
  object_types[i++] = gsgf_component_get_type ();
  object_types[i++] = gsgf_compose_get_type ();
  object_types[i++] = gsgf_cooked_value_get_type ();
  object_types[i++] = gsgf_date_get_type ();
  object_types[i++] = gsgf_double_get_type ();
  object_types[i++] = gsgf_empty_get_type ();
  object_types[i++] = gsgf_flavor_backgammon_get_type ();
  object_types[i++] = gsgf_flavor_get_type ();
  object_types[i++] = gsgf_game_tree_get_type ();
  object_types[i++] = gsgf_list_of_get_type ();
  object_types[i++] = gsgf_move_backgammon_get_type ();
  object_types[i++] = gsgf_move_get_type ();
  object_types[i++] = gsgf_node_get_type ();
  object_types[i++] = gsgf_number_get_type ();
  object_types[i++] = gsgf_point_backgammon_get_type ();
  object_types[i++] = gsgf_point_get_type ();
  object_types[i++] = gsgf_property_get_type ();
  object_types[i++] = gsgf_raw_get_type ();
  object_types[i++] = gsgf_real_get_type ();
  object_types[i++] = gsgf_result_get_type ();
  object_types[i++] = gsgf_simple_text_get_type ();
  object_types[i++] = gsgf_stone_backgammon_get_type ();
  object_types[i++] = gsgf_stone_get_type ();
  object_types[i++] = gsgf_text_get_type ();
  object_types[i++] = gsgf_value_get_type ();
...
/* The output files */
const gchar *signals_filename = "./libgsgf.signals.new";
const gchar *hierarchy_filename = "./libgsgf.hierarchy.new";
const gchar *interfaces_filename = "./libgsgf.interfaces.new";
const gchar *prerequisites_filename = "./libgsgf.prerequisites.new";
const gchar *args_filename = "./libgsgf.args.new";
...
output_object_hierarchy (void)
{
  ...
  gint i,j;
  GType root, type;
  GType root_types[28] = { G_TYPE_INVALID, };
